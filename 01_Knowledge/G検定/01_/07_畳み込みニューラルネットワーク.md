...
| EfficientDet                        | 2019年 | Mingxing Tan  | EfficientNetをバックボーンに利用し、<font color="#ffff00">BiFPN (Bi-directional Feature Pyramid Network)</font>で特徴を融合。高い精度と効率性を両立させ、最先端のモデルとなりました。                          |          |
## データ拡張
