...
また、業務外でも社内への価値提供を目的として、
社内向けタイピングアプリを提案から運用までを主導し3名のチームを牽引しました。
こちらは、現在も社内で継続利用されています。

さらに、タイピングアプリで蓄積されたスコアデータを分析するツールも開発し、
可視化ロジックやUI設計などを担うなど、データ利活用にも積極的に取り組んでいます。
